...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ro.unibuc.fmi.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ro.unibuc.fmi.repository.UserRepository.USERS_BY_EMAIL_CACHE);
